...
class FB(nn.Module):
    ...
    def forward(self, f1, f2):
        ...
        return out
#     f b 56 256 256
#     shuffle_conv 28 2 1 1


class Net_DPU(torch.nn.Module):
    def __init__(self, opt):
        super(Net_DPU, self).__init__()
        netlayer = []
    ...
    def forward(self, g, input_mask=None):
        ...
        # hsi phi[2,28,256,256]
        # hsi PhiPhiT[2,1,256,310] 对phi移位之后每个元素平方再求和
        # hsi g[2,1,256,310]
        Phi, PhiPhiT = input_mask
        Phi_shift = self.shift(Phi, len_shift=2)
        # hsi phi[2,28,256,310]
        # Phi_compressive[2,1,256,310]
