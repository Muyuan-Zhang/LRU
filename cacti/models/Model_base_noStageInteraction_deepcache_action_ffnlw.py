...
class NetVideo_base_noStageInteraction_deepcache_action_ffnlw(torch.nn.Module):
    def __init__(self, opt):
        super(NetVideo_base_noStageInteraction_deepcache_action_ffnlw, self).__init__()
