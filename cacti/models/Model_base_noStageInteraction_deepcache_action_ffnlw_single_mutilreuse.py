...
class NetVideo_base_noStageInteraction_deepcache_action_ffnlw_single_multireuse(torch.nn.Module):
    def __init__(self, opt):
        super(NetVideo_base_noStageInteraction_deepcache_action_ffnlw_single_multireuse, self).__init__()
