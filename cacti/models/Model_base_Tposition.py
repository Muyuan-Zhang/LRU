...
class TimesAttention3D(nn.Module):
    def __init__(self, dim, num_head, qkv_bias=False, qk_scale=None):
        ...
        self.pos_emb = nn.Parameter(torch.Tensor(1, self.num_heads, 8, 8))
    ...
    def forward(self, x):
        ...
        q = q * self.scale
        attn = q @ k.transpose(-2, -1) + self.pos_emb
...
class NetVideo_base_Tposition(torch.nn.Module):
    def __init__(self, opt):
        super(NetVideo_base_Tposition, self).__init__()
