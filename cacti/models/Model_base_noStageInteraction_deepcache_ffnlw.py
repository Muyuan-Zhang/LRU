...
class IPB(nn.Module):
    ...
    def forward(self, x, stage_ins=None, skip=False, stage_outs=None):
        ...
        if not skip:
            ...
            x1 = self.down1(x)
            x1 = self.downReuse1(x1, stage_ins[0])
...
class NetVideo_base_noStageInteraction_deepcache_ffnlw(torch.nn.Module):
    def __init__(self, opt):
        super(NetVideo_base_noStageInteraction_deepcache_ffnlw, self).__init__()
