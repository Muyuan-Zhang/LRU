...
class NetVideo_conv3d_TSAB_shareBody_action_changeSample_seriesConnection(torch.nn.Module):
    def __init__(self, opt):
        super(NetVideo_conv3d_TSAB_shareBody_action_changeSample_seriesConnection, self).__init__()
