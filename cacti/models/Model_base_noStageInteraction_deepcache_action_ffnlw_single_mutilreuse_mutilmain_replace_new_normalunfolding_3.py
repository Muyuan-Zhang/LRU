...
class DSTCT(nn.Module):
    def __init__(self, in_dim=8, out_dim=4, dim=4):
        ...
        self.reuse = STCAB(dim=dim, sq_dim=dim, dim_head=dim, mult=4)
...
class NetVideo_base_noStageInteraction_deepcache_action_ffnlw_single_multireuse_multimain_replace_new_normalunfolding_3(
    torch.nn.Module):
